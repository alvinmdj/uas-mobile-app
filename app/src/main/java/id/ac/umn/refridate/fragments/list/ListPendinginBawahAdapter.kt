...
class ListPendinginBawahAdapter: RecyclerView.Adapter<ListPendinginBawahAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.displayLayout.setOnClickListener{
            val action1 = ListPendinginBawahFragmentDirections.actionListPendinginBawahFragmentToUpdatePendinginBawahFragment(currentItem)
            holder.itemView.findNavController().navigate(action1)
        }
        holder.itemView.displayItem.setOnClickListener{
            val action2 = ListPendinginBawahFragmentDirections.actionListPendinginBawahFragmentToDetailFragment2(currentItem)
