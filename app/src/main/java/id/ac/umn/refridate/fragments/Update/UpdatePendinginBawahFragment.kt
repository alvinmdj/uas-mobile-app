...
import kotlinx.android.synthetic.main.fragment_pendinginbawah_update.Nama_update
import kotlinx.android.synthetic.main.fragment_pendinginbawah_update.dateTv_update
import kotlinx.android.synthetic.main.fragment_pendinginbawah_update.view.*
import kotlinx.android.synthetic.main.fragment_pendinginbawah_update.view.Nama_update
import kotlinx.android.synthetic.main.fragment_pendinginbawah_update.view.Tanggal_update
import kotlinx.android.synthetic.main.fragment_pendinginbawah_update.view.confirm_update
import kotlinx.android.synthetic.main.fragment_pendinginbawah_update.view.dateTv_update
import java.text.SimpleDateFormat

import java.util.*
import java.util.concurrent.TimeUnit

class UpdatePendinginBawahFragment : Fragment() {

    private lateinit var mFirebaseStorage: FirebaseStorage
    private lateinit var mFirebaseInstance: FirebaseDatabase
    private lateinit var mDatabaseReference: DatabaseReference
    private val args by navArgs<UpdatePendinginBawahFragmentArgs>()

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {
        // Inflate the layout for this fragment
        val view = inflater.inflate(R.layout.fragment_pendinginbawah_update, container, false)
    ...
    private fun updateItem(){
        ...
        {
            val updatedItem = ItemList(args.currItem.id, name, "Pendingin Bawah", date_time, args.currItem.image)
            ...
            findNavController().navigate(R.id.action_updatePendinginBawahFragment_to_listPendinginBawahFragment)
        }
        else
        {
    ...
    private fun deleteItem(){
        ...
        builder.setPositiveButton("Iya"){_, _ ->
            ...
            imageRef.delete().addOnSuccessListener(OnSuccessListener<Void?> {
                Log.d(ContentValues.TAG, "onSuccess: success delete image file")
            }).addOnFailureListener(OnFailureListener {
                Log.d(ContentValues.TAG, "onFailure:failed to delete image file")
            })
